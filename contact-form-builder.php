...
function contact_form_maker_options_panel() {
  ...
  $licensing_plugins_page = add_submenu_page('manage_cfm', __('Licensing/Donation', 'contact_form_maker'), __('Licensing/Donation', 'contact_form_maker'), 'manage_options', 'licensing_cfm', 'contact_form_maker');
